...
appColorTable:
    ...
    .db     (APP_COLOR_WHITE  << 4) | APP_COLOR_BLACK, (APP_COLOR_WHITE  << 4) | APP_COLOR_BLACK
    .db     (APP_COLOR_WHITE  << 4) | APP_COLOR_BLACK, (APP_COLOR_WHITE  << 4) | APP_COLOR_BLACK
    .db     (APP_COLOR_WHITE  << 4) | APP_COLOR_BLACK, (APP_COLOR_WHITE  << 4) | APP_COLOR_BLACK
    .db     (APP_COLOR_WHITE  << 4) | APP_COLOR_BLACK, (APP_COLOR_WHITE  << 4) | APP_COLOR_BLACK
    .db     (APP_COLOR_BLUE   << 4) | APP_COLOR_BLACK, (APP_COLOR_BLUE   << 4) | APP_COLOR_BLACK
    .db     (APP_COLOR_WHITE  << 4) | APP_COLOR_BLACK, (APP_COLOR_WHITE  << 4) | APP_COLOR_BLACK
    .db     (APP_COLOR_WHITE  << 4) | APP_COLOR_BLACK, (APP_COLOR_PURPLE << 4) | APP_COLOR_BLACK
    .db     (APP_COLOR_ORANGE << 4) | APP_COLOR_BLACK, (APP_COLOR_GREEN  << 4) | APP_COLOR_ORANGE
    .db     (APP_COLOR_PURPLE << 4) | APP_COLOR_BLACK, (APP_COLOR_BLUE   << 4) | APP_COLOR_BLACK
    .db     (APP_COLOR_BLUE   << 4) | APP_COLOR_BLACK, (APP_COLOR_BLUE   << 4) | APP_COLOR_BLACK
    .db     (APP_COLOR_WHITE  << 4) | APP_COLOR_BLACK, (APP_COLOR_WHITE  << 4) | APP_COLOR_BLACK
    .db     (APP_COLOR_WHITE  << 4) | APP_COLOR_BLACK, (APP_COLOR_WHITE  << 4) | APP_COLOR_BLACK
    .db     (APP_COLOR_WHITE  << 4) | APP_COLOR_BLACK, (APP_COLOR_WHITE  << 4) | APP_COLOR_BLACK
